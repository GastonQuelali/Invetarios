...
builder.Services.AddRazorPages(options =>
{
    ...
    options.Conventions.AllowAnonymousToPage("/Perfiles/Create"); options.Conventions.AllowAnonymousToPage("/Perfiles/Create"); 
    ...
    options.Conventions.AllowAnonymousToPage("/Usuarios/Create"); options.Conventions.AllowAnonymousToPage("/Usuarios/Create"); 
