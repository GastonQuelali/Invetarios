...
namespace RPInventarios.Migrations
{
    ...
    [Migration("20250210011743_RelacionProductoCategoriaOpcional")]
    partial class RelacionProductoCategoriaOpcional
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RPInventarios.Models.Categoria", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("CategoriaIdPadre")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RPInventarios.Models.ProductoCategoria", b =>
                {
            ...
            modelBuilder.Entity("RPInventarios.Models.Categoria", b =>
                {
                    b.HasOne("RPInventarios.Models.Categoria", "CategoriaPadre")
            ...
            modelBuilder.Entity("RPInventarios.Models.ProductoCategoria", b =>
                {
                    b.HasOne("RPInventarios.Models.Categoria", "Categoria")
                        .WithMany("ProductoCategorias")
                        .HasForeignKey("CategoriaId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .IsRequired();

                    b.HasOne("RPInventarios.Models.Producto", "Producto")
                        .WithMany("ProductoCategorias")
